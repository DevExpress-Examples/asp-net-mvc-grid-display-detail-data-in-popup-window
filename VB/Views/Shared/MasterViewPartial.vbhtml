                              ...
                              Sub(container)
                                  Html.DevExpress().HyperLink(
                                     Sub(hlSettings)
                                             ...
                                             hlSettings.Properties.ClientSideEvents.Click = string.Format("function(s, e) {{ ShowDetailPopup('{0}'); }}", Url.Action("DetailAction", "Home", New With { Key. _customerID = TryCast(container, GridViewDataItemTemplateContainer).KeyValue.ToString() }))
